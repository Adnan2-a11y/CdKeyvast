            ...
            <div className="space-y-6 text-gray-700">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">2.2 Technical Information</h3>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">2.3 Cookies and Tracking</h3>
                    <p>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 mt-2 space-y-2">
                  <li><strong>Service Provision:</strong> To process orders and deliver digital products</li>
                  <li><strong>Account Management:</strong> To create and manage your account</li>
                  <li><strong>Customer Support:</strong> To respond to inquiries and provide assistance</li>
                  <li><strong>Security:</strong> To detect and prevent fraud and protect our services</li>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      our business, such as payment processors, email services, and analytics providers.
                    </p>
                  </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">7.1 Access and Correction</h3>
                    <p>You can access and update your personal information through your account settings or by contacting us.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">7.2 Deletion</h3>
                    <p>You can request deletion of your personal information, subject to legal and operational requirements.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">7.3 Portability</h3>
                    <p>You can request a copy of your personal information in a structured, machine-readable format.</p>
                  </div>

                  <div>
                    <h3 className="text-lg font-semibold text-gray-900">7.4 Opt-Out</h3>
                    <p>You can opt out of marketing communications at any time by clicking the unsubscribe link or contacting us.</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                <h2 className="text-2xl font-bold mb-4 text-gray-900">10. Website Analytics</h2>
                <p>
                  We use analytics services to understand how our website is used. These services may 
                  collect information about your usage patterns. The data is anonymized and aggregated 
                  for analytical purposes.
                </p>
              </div>

              <div>
                <h2 className="text-2xl font-bold mb-4 text-gray-900">11. Third-Party Links</h2>
                <p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-md mt-2">
                  <p><strong>Email:</strong> privacy@CdkeyVast.com</p>
                  <p><strong>Support:</strong> support@CdkeyVast.com</p>
